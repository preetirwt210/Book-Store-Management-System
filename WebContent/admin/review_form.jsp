...
<title>
   Edit Review-Evergreen Bookstore Administration
   </title>
    ...
    <input type="hidden" name="reviewId" value="${review.reviewId }"/>
         ...
         <tr>
              <td align="right">Headline: </td>
               <td align="left"><input type="text" size="60" name="headline" size="20" value="${review.headline }"/></td>         
         </tr>
         <tr>
...
$(document).ready(function(){
	$("#reviewForm").validate({
		...
		messages:{
				headline:"headline should not be empty",

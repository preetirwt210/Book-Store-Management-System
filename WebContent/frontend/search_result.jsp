...
<body>
      ...
      <a href="view_books?id=${book.bookId}">
       <img src="data:imagejpg;base64,${book.base64Image }" width="120" height="160"/></a></div></div>
      ...
      <div><h2><a href="view_book?id=${book.bookId}"><b>${book.title }</b></a></h2></div>
       <div>rating *****</div>
        <div><i>by ${book.author}</i></div>
         ...
         <div style="display:inline-block; margin:20px; vertical-align:top;"><h3>$${book.price }</h3>
             <h3><a href="">Add To Cart</a></h3></div>
         </div>
      	</c:forEach>
      </div>
